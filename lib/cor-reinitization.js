/*
    Script: cor-reinitization.js
    Description: if same service called by same user within 15 minutes, put them in the same place they were; note -- need to add current step
    Status: barely started

    Note: this is important for the pin stuff in particular ... but should probably be here for all services. Need to add a step tracker everywhere.
*/

module.exports = function(){
    // load relevant tables
    var session_table = project.getOrCreateDataTable('PIN Testing');
