...
default replacement string is xxx, but this can be supplied as the regex arg
...
module.exports.get_message = function(msg_lang, msg_name, opts = [], regex = /xxx/, console_lang = 'en'){
    var output = '';
    try{
