...
module.exports.get_message = function(msg_name, opts, console_lang){
    var output = '';
    var msg_lang = project.getOrCreateDataTable('ussd_settings').queryRows({'vars' : {'settings' : 'lang'}}).next().vars.value;
    opts = opts || {};
