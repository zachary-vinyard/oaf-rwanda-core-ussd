...
module.exports = function(client, input_menu_name, lang){
    ...
    var next_page = next_prev_tab.queryRows({'vars' : {'name' : 'next_page'}}).next().vars[lang] || '44)Next';
    var prev_page = next_prev_tab.queryRows({'vars' : {'name' : 'prev_page'}}).next().vars[lang] || '77)Previous';
