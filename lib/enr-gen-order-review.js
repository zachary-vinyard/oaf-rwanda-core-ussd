...
function rgo_prepayment_calc(client, input_menu_name){
    ...
    if(!new_client){
        ...
        console.log('balance is ' + balance + 'and credit is ' + credit);
        // calculate necessary figures
        const req_perc = 0.6;
        var perc_repaid = (credit - balance) / credit;
        var remainder = (perc_repaid - req_perc) * credit;
        console.log('perc repaid is ' + perc_repaid + 'and remainder is ' + remainder);
        ...
        if(perc_repaid < req_perc){
            ...
            messager('0789193377', enr_repayment_sms);
        }
    }
    else{
